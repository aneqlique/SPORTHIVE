...
public class HomeController {
    ...
    // Goes to Mainlist.fxml
    public void gotoMainlist(ActionEvent event) throws IOException {

        Parent root = FXMLLoader.load(getClass().getResource("/Mainlist/Mainlist.fxml"));
