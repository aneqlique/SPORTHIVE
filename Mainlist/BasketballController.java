...
public class BasketballController {
    ...
    // Goes to Outdoor.fxml
    public void gotoOutdoor(ActionEvent event) throws IOException {

        Parent root = FXMLLoader.load(getClass().getResource("/Mainlist/Outdoor.fxml"));
        Scene scene = new Scene(root);
        stage = (Stage) ((Node) event.getSource()).getScene().getWindow();
        stage.setScene(scene);
        stage.show();
